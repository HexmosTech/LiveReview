...
# this same provider). Models are vendor-namespaced, e.g. "google/gemini-2.5-flash".
    ...
    for attempt in range(3):
        req = urllib.request.Request(
            ...
            headers={
                ...
                # Cloudflare (fronting api.atlascloud.ai) blocks the default
                # "Python-urllib/x.y" user agent as a bot signature (error
                # 1010) before the request even reaches Atlas - a real UA
                # avoids that.
