...
3. Treat every other input as an assumption and must name it as one.
...
6. Colour additions and subtractions differently and must let the final bar carry the net figure.
