...
id: livi.prompts.finalize
---

<!-- alaws:commentary -->

Call #3, made once per report after Planning's count is known. Assembled
from General, the whole of Chart Selection (every family, laws and
worked-example specs both — Finalizing is the stage that actually draws
the chart), and Finalizing itself.
...
{{ref:livi.finalizing.output}}

{{ref:livi.finalizing.response_shape}}

{{ref:livi.finalizing.chart}}

{{ref:livi.finalizing.describing}}
