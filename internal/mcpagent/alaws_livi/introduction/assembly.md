...
**[Classification](alaws:livi.classify)** — is this a data question, an action, or conversation?
...
**[Finalizing](alaws:livi.finalizing)** — the query that produces the answer, and the shape it
takes.
*Sent: [General](alaws:livi.general) + [Chart Selection](alaws:livi.charts) (laws and specification examples both) +
[Finalizing](alaws:livi.finalizing).*

**[Degraded paths](alaws:livi.degraded)** — a rejected query, or a result with no rows.
*Sent: [General](alaws:livi.general) + [Degraded Paths](alaws:livi.degraded).*

## Why [General](alaws:livi.general) is sent to every call
...
## Why [Chart Selection](alaws:livi.charts) is sent twice
...
[Chart Selection](alaws:livi.charts) chapter's individual sections for the specific
