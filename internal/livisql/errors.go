...
const (
	...
	CodeCrossSchema      RejectionCode = "cross_schema"
	CodeUnknownTable     RejectionCode = "unknown_table"
	CodeUnknownFunc      RejectionCode = "unknown_function"
	CodeSecretColumn     RejectionCode = "secret_column"
	CodeStarSelect       RejectionCode = "star_select"
	CodeMissingOrgFilter RejectionCode = "missing_org_filter"
	CodeWrongOrg         RejectionCode = "wrong_org_id"
	CodeTautology        RejectionCode = "tautology"
