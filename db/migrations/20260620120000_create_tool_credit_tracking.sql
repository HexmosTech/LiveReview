...
-- Remove the diff column as we are not storing diffs in DB
...
CREATE TABLE IF NOT EXISTS public.org_tool_billing_state (
    ...
    credits_used_month DOUBLE PRECISION NOT NULL DEFAULT 0.0,
    credits_limit_month DOUBLE PRECISION NOT NULL DEFAULT 50000.0,
