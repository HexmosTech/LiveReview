...
This includes [comments, threads](https://docs.gitlab.com/user/discussions/), and system notes.
...
## Understand note types in the API [Permalink](https://docs.gitlab.com/api/discussions/\#understand-note-types-in-the-api "Permalink")
...
Not available in the [Events API](https://docs.gitlab.com/api/events/).

## Discussions pagination [Permalink](https://docs.gitlab.com/api/discussions/\#discussions-pagination "Permalink")

By default, `GET` requests return 20 results at a time because the API results are paginated.

Read more on [pagination](https://docs.gitlab.com/api/rest/#pagination).

## Issues [Permalink](https://docs.gitlab.com/api/discussions/\#issues "Permalink")

### List project issue discussion items [Permalink](https://docs.gitlab.com/api/discussions/\#list-project-issue-discussion-items "Permalink")
...
### Get single issue discussion item [Permalink](https://docs.gitlab.com/api/discussions/\#get-single-issue-discussion-item "Permalink")
...
### Create new issue thread [Permalink](https://docs.gitlab.com/api/discussions/\#create-new-issue-thread "Permalink")
...
### Add note to existing issue thread [Permalink](https://docs.gitlab.com/api/discussions/\#add-note-to-existing-issue-thread "Permalink")
...
### Modify existing issue thread note [Permalink](https://docs.gitlab.com/api/discussions/\#modify-existing-issue-thread-note "Permalink")
...
### Delete an issue thread note [Permalink](https://docs.gitlab.com/api/discussions/\#delete-an-issue-thread-note "Permalink")
...
## Snippets [Permalink](https://docs.gitlab.com/api/discussions/\#snippets "Permalink")

### List project snippet discussion items [Permalink](https://docs.gitlab.com/api/discussions/\#list-project-snippet-discussion-items "Permalink")
...
### Get single snippet discussion item [Permalink](https://docs.gitlab.com/api/discussions/\#get-single-snippet-discussion-item "Permalink")
...
### Create new snippet thread [Permalink](https://docs.gitlab.com/api/discussions/\#create-new-snippet-thread "Permalink")
...
### Add note to existing snippet thread [Permalink](https://docs.gitlab.com/api/discussions/\#add-note-to-existing-snippet-thread "Permalink")
...
### Modify existing snippet thread note [Permalink](https://docs.gitlab.com/api/discussions/\#modify-existing-snippet-thread-note "Permalink")
...
### Delete a snippet thread note [Permalink](https://docs.gitlab.com/api/discussions/\#delete-a-snippet-thread-note "Permalink")
...
## Epics [Permalink](https://docs.gitlab.com/api/discussions/\#epics "Permalink")
...
- GitLab 17.4 to 18.0: Required when [the new look for epics](https://docs.gitlab.com/user/group/epics/#epics-as-work-items)
is enabled.
...
### List group epic discussion items [Permalink](https://docs.gitlab.com/api/discussions/\#list-group-epic-discussion-items "Permalink")
...
### Get single epic discussion item [Permalink](https://docs.gitlab.com/api/discussions/\#get-single-epic-discussion-item "Permalink")
...
### Create new epic thread [Permalink](https://docs.gitlab.com/api/discussions/\#create-new-epic-thread "Permalink")
...
### Add note to existing epic thread [Permalink](https://docs.gitlab.com/api/discussions/\#add-note-to-existing-epic-thread "Permalink")

Adds a new note to the thread. This can also
[create a thread from a single comment](https://docs.gitlab.com/user/discussions/#create-a-thread-by-replying-to-a-standard-comment).
...
### Modify existing epic thread note [Permalink](https://docs.gitlab.com/api/discussions/\#modify-existing-epic-thread-note "Permalink")
...
### Delete an epic thread note [Permalink](https://docs.gitlab.com/api/discussions/\#delete-an-epic-thread-note "Permalink")
...
## Merge requests [Permalink](https://docs.gitlab.com/api/discussions/\#merge-requests "Permalink")

### List project merge request discussion items [Permalink](https://docs.gitlab.com/api/discussions/\#list-project-merge-request-discussion-items "Permalink")
...
### Get single merge request discussion item [Permalink](https://docs.gitlab.com/api/discussions/\#get-single-merge-request-discussion-item "Permalink")
...
### Create new merge request thread [Permalink](https://docs.gitlab.com/api/discussions/\#create-new-merge-request-thread "Permalink")
...
see [Post comment to commit](https://docs.gitlab.com/api/commits/#post-comment-to-commit) in the Commits API,
and [Create new merge request note](https://docs.gitlab.com/api/notes/#create-new-merge-request-note) in the Notes API.
...
#### Create a new thread on the overview page [Permalink](https://docs.gitlab.com/api/discussions/\#create-a-new-thread-on-the-overview-page "Permalink")
...
#### Create a new thread in the merge request diff [Permalink](https://docs.gitlab.com/api/discussions/\#create-a-new-thread-in-the-merge-request-diff "Permalink")
...
1. [Get the latest merge request version](https://docs.gitlab.com/api/merge_requests/#get-merge-request-diff-versions):
...
#### Parameters for multiline comments [Permalink](https://docs.gitlab.com/api/discussions/\#parameters-for-multiline-comments "Permalink")
...
#### Line code [Permalink](https://docs.gitlab.com/api/discussions/\#line-code "Permalink")
...
### Resolve a merge request thread [Permalink](https://docs.gitlab.com/api/discussions/\#resolve-a-merge-request-thread "Permalink")
...
### Add note to existing merge request thread [Permalink](https://docs.gitlab.com/api/discussions/\#add-note-to-existing-merge-request-thread "Permalink")
...
### Modify an existing merge request thread note [Permalink](https://docs.gitlab.com/api/discussions/\#modify-an-existing-merge-request-thread-note "Permalink")
...
### Delete a merge request thread note [Permalink](https://docs.gitlab.com/api/discussions/\#delete-a-merge-request-thread-note "Permalink")
...
## Commits [Permalink](https://docs.gitlab.com/api/discussions/\#commits "Permalink")

### List project commit discussion items [Permalink](https://docs.gitlab.com/api/discussions/\#list-project-commit-discussion-items "Permalink")
...
### Get single commit discussion item [Permalink](https://docs.gitlab.com/api/discussions/\#get-single-commit-discussion-item "Permalink")
...
### Create new commit thread [Permalink](https://docs.gitlab.com/api/discussions/\#create-new-commit-thread "Permalink")
...
[creating a new thread in the merge request diff](https://docs.gitlab.com/api/discussions/#create-a-new-thread-in-the-merge-request-diff).
The exceptions:
...
### Add note to existing commit thread [Permalink](https://docs.gitlab.com/api/discussions/\#add-note-to-existing-commit-thread "Permalink")
...
### Modify an existing commit thread note [Permalink](https://docs.gitlab.com/api/discussions/\#modify-an-existing-commit-thread-note "Permalink")
...
### Delete a commit discussion note [Permalink](https://docs.gitlab.com/api/discussions/\#delete-a-commit-discussion-note "Permalink")
