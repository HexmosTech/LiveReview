...
DB_PASSWORD=EXAMPLE_DB_PASSWORD_CHANGE_ME
DATABASE_URL=postgres://livereview:EXAMPLE_DB_PASSWORD_CHANGE_ME@livereview-db:5432/livereview?sslmode=disable

# Security Configuration
JWT_SECRET=EXAMPLE_JWT_SECRET_CHANGE_ME
