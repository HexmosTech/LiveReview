...
DB_PASSWORD=[REDACTED_GITLEAKS_19]
DATABASE_URL=postgres://livereview:[REDACTED_GITLEAKS_19]@livereview-db:5432/livereview?sslmode=disable

# Security Configuration
JWT_SECRET=[REDACTED_GITLEAKS_20]
