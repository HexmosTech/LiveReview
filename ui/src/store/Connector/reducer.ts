...
export type ConnectorType = 'gitlab-com' | 'gitlab-self-hosted' | 'gitlab' | 'github' | 'bitbucket' | 'gitea' | 'custom';
...
export const { addConnector, removeConnector, updateConnector, setConnectors } = connectorSlice.actions;
