            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-slate-800 rounded-xl border border-slate-700 p-6 mb-8">
                    <div className="mb-4">
                        ...
                        {(isCancelled || isScheduledToCancel) && subscription.current_period_end && (
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-400 text-sm mt-1">
                                            Your access will remain active until <span className="text-white">{moment.tz(subscription.current_period_end, moment.tz.guess()).format('MMM D, YYYY')}</span>.
                                            After this date, your organization will be reverted to the Free plan.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="mt-4 text-sm text-slate-400">
                            {subscription.created_at && (
                                <span className="mr-6">
                                    Created: <span className="text-slate-300">{moment.tz(subscription.created_at, moment.tz.guess()).format('MMM D, YYYY')}</span>
                                </span>
                            )}
                            {subscription.current_period_end && (
                                <span>
                                    {isCancelled || isScheduledToCancel ? 'Expires:' : 'Renews:'} <span className="text-slate-300">{moment.tz(subscription.current_period_end, moment.tz.guess()).format('MMM D, YYYY')}</span>
                                </span>
                            )}
                        </div>
                    </div>
