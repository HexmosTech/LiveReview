...
export const SafetyBanner: React.FC<SafetyBannerProps> = ({ 
  ...
  return (
    <div className={classNames(
      'rounded-lg bg-gradient-to-br from-blue-900/30 via-purple-900/20 to-cyan-900/30 border border-blue-400/30 p-5 w-full',
      className
    )}>
      <div className="flex flex-col lg:flex-row lg:items-start gap-5">
        {/* Column 1 - Description (50%) */}
        <div className="w-full lg:basis-1/2 flex items-start gap-4">
        ...
        <div className="w-full lg:basis-1/4 flex-shrink-0">
          <button
            type="button"
            className="group w-full rounded border border-slate-500/70 hover:border-cyan-400 transition-colors bg-slate-800/60 hover:bg-slate-800 p-3 h-40 flex items-center justify-center relative"
